...
function rnWorkshop(state = {}, action) {
  switch (action.type) {
    ...
    case SET_MESSAGES:
      return Object.assign({}, state, { messages: action.messages, isFetchingMessages: false })
    case SET_MESSAGE:
      return Object.assign({}, state, { message: action.message, isFetchingMessages: false })
    case SET_VIEW:
